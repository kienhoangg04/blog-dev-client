...
import { replyComments, updateComment, deleteComment } from '../../redux/actions/commentAction';
...
const CommentList: React.FC<IProps> = ({ children, comment, showReply, setShowReply, onComment }) => {
